...
DIR_WITH_DEFAULT_FILES = (
    DIR_WITH_TEST_UPDATE_PROFILES_INVENTORIES / "default"
)

DIR_WITH_FILES_CHANGED = (
    DIR_WITH_TEST_UPDATE_PROFILES_INVENTORIES / "changed"
)

DIR_WITH_TEMPORARY_FILES = (
    DIR_WITH_TEST_UPDATE_PROFILES_INVENTORIES / "tmp"
)

DIR_WITH_DEFAULT_FEATURE_PROFILES = (
    DIR_WITH_DEFAULT_FILES / "feature_profiles"
)

DIR_WITH_DEFAULT_INVENTORIES = (
    DIR_WITH_DEFAULT_FILES / "inventories"
)

PATH_TO_FILE_WITH_DEFAULT_FEATURES_LISTED_VALUES = DIR_WITH_DEFAULT_INVENTORIES / "features_listed_values.csv"
