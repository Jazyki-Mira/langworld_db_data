...
from langworld_db_data.constants.paths import FILE_WITH_GENEALOGY_HIERARCHY, FILE_WITH_GENEALOGY_NAMES
...
class GenealogyValidator:
    ...
    def __init__(
        ...
        self.family_ids_from_file_with_names = [row['id'] for row in read_csv(self.file_with_names, read_as='dicts')]

        self.family_ids_from_file_with_hierarchy = []
    ...
    def _check_and_get_ids_from_hierarchy(self) -> list[str]:
        ...
        for line in lines:
            ...
            if not match:
                raise GenealogyValidatorError(f'Family ID in line {line} is incorrectly formed. '
        ...
        print('OK: All family IDs in the hierarchy are formed correctly and match IDs in list of families')
    ...
    def _check_ids_in_list_of_names(self, ids_from_hierarchy: list[str]):
        """
        ...
        print('OK: All family IDs in file with names of families are formed correctly '
