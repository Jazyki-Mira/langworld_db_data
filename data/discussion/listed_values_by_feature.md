...
- **Верхний, средне-верхний, средне-нижний и нижний** (A-2-6): кол-во языков — **15**
...
- **Передний, средний и задний** (A-3-4): кол-во языков — **190**
...
- **Фонологические ступени долготы отсутствуют** (A-4-1): кол-во языков — **122**
- **Две ступени** (A-4-2): кол-во языков — **159**
...
- **Только дифтонги** (A-9-2): кол-во языков — **121**
...
- **Нисходящие** (A-10-2): кол-во языков — **55**
...
- **Противопоставление по звонкости/глухости** (A-11-1): кол-во языков — **214**
...
- **Лабиальные, переднеязычные, среднеязычные, заднеязычные и постувулярные** (A-13-2): кол-во языков — **140**
- **Лабиальные, переднеязычные, среднеязычные и заднеязычные** (A-13-3): кол-во языков — **101**
...
- **Только билабиальные** (A-14-1): кол-во языков — **100**
- **Билабиальные и лабиодентальные** (A-14-2): кол-во языков — **215**
...
- **Только ларингальные** (A-17-4): кол-во языков — **20**

## A-18 — Дополнительные артикуляционные противопоставления шумных согласных

- **Отсутствуют** (A-18-1): кол-во языков — **145**
- **По лабиализации** (A-18-2): кол-во языков — **26**
...
- **Назальные, плавные, вибранты и глайды** (A-19-6): кол-во языков — **183**
...
- **Лабиальные, переднеязычные и среднеязычные** (A-20-14): кол-во языков — **138**
...
- **Лабиальные, переднеязычные, среднеязычные и заднеязычные** (A-20-17): кол-во языков — **80**
...
- **Отсутствуют** (A-21-1): кол-во языков — **170**
...
- **Динамическое** (B-2-1): кол-во языков — **187**
...
- **Нефонологическая** (B-9-2): кол-во языков — **67**
...
- **Есть закрытые и открытые слоги** (C-2-5): кол-во языков — **244**

## D-1 — Ограничения на фонемную структуру сегментных морфем в начальной позиции

- **Отсутствуют** (D-1-1): кол-во языков — **35**
...
- **Запрет на любые стечения согласных** (D-1-6): кол-во языков — **55**
...
- **Запрет на любые стечения согласных** (D-2-7): кол-во языков — **16**
...
- **Отсутствуют** (D-4-1): кол-во языков — **51**
...
- **Отсутствуют** (D-6-1): кол-во языков — **52**
...
- **Вокалические и консонантные** (D-8-6): кол-во языков — **77**
...
- **Флективный** (E-1-3): кол-во языков — **90**
- **Флективный с элементами агглютинации** (E-1-4): кол-во языков — **51**
- **Флективно-агглютинативный** (E-1-5): кол-во языков — **26**
...
- **Синтетический** (E-4-5): кол-во языков — **56**
- **Синтетический с элементами аналитизма** (E-4-6): кол-во языков — **199**
- **Синтетический с элементами полисинтетизма** (E-4-7): кол-во языков — **1**

## F-1 — Количество согласовательных классов

- **Согласовательные классы отсутствуют** (F-1-1): кол-во языков — **180**
- **Два** (F-1-2): кол-во языков — **103**
...
- **В прилагательном и глаголе** (F-3-12): кол-во языков — **10**
...
- **Только в единственном числе** (F-5-1): кол-во языков — **30**
...
- **Отсутствует** (F-6-1): кол-во языков — **42**
...
- **Лексическое** (F-8-1): кол-во языков — **29**
...
- **Лексический** (F-9-1): кол-во языков — **34**
...
- **Единственное и множественное** (G-1-1): кол-во языков — **326**
...
- **Немаркированное** (G-2-2): кол-во языков — **229**
...
- **Предикативное** (G-4-2): кол-во языков — **103**
...
- **Единственное и множественное число** (G-5-3): кол-во языков — **132**
...
- **Двадцатеричная** (G-6-7): кол-во языков — **20**
...
- **Неопределенный артикль отсутствует** (G-7-1): кол-во языков — **199**
- **Совпадают** (G-7-2): кол-во языков — **55**
- **Не совпадают** (G-7-3): кол-во языков — **12**

## H-1 — Количество падежей у имени существительного

- **Один-два** (H-1-1): кол-во языков — **58**
- **Три-семь** (H-1-2): кол-во языков — **146**
...
- **Генитив** (H-4-3): кол-во языков — **136**
- **Датив** (H-4-4): кол-во языков — **1**
- **Комитатив** (H-4-5): кол-во языков — **0**
- **Косвенный** (H-4-6): кол-во языков — **6**
...
- **Настоящее-будущее и прошедшее** (I-5-6): кол-во языков — **63**
- **Настоящее, прошедшее и будущее** (I-5-7): кол-во языков — **159**
- **Настоящее, прошедшее и настоящее-будущее** (I-5-8): кол-во языков — **9**
- **Настоящее, настоящее-будущее, будущее и прошедшее** (I-5-9): кол-во языков — **16**
...
- **Синкретическое** (I-6-2): кол-во языков — **174**
...
- **Лицо, число, род, время, вид и модальность (наклонение)** (I-8-19): кол-во языков — **25**
...
- **В единственном и множественном числе** (I-9-3): кол-во языков — **204**
...
- **Особый тип согласования** (I-10-5): кол-во языков — **34**
- **Изменение типа спряжения** (I-10-6): кол-во языков — **20**
- **Аффикс и служебное слово** (I-10-7): кол-во языков — **0**
- **Аффикс и особый тип согласования** (I-10-8): кол-во языков — **9**
...
- **Местоимения-существительные и местоимения-прилагательные** (J-1-11): кол-во языков — **69**
...
- **Указательные местоимения** (J-2-1): кол-во языков — **59**
...
- **Указательные местоимения и артикли** (J-2-12): кол-во языков — **8**
...
- **Послелоги** (J-3-2): кол-во языков — **62**
...
- **Местоимения** (J-4-4): кол-во языков — **39**
...
- **Различное падежное оформление определенного и неопределенного объекта** (J-5-10): кол-во языков — **15**
...
- **Артикли** (J-6-1): кол-во языков — **56**
...
- **Числительные** (J-6-7): кол-во языков — **12**
...
- **Отрицательные аффиксы** (J-8-1): кол-во языков — **35**
...
- **Отрицательные частицы и аффиксы** (J-8-9): кол-во языков — **29**
...
- **Препозиция** (J-9-3): кол-во языков — **136**
...
- **Артикли отсутствуют** (K-2-1): кол-во языков — **209**
- **Только неопределенные** (K-2-2): кол-во языков — **20**
...
- **Субъектное** (K-7-2): кол-во языков — **212**
- **Субъектное и объектное** (K-7-3): кол-во языков — **29**
...
- **Род, число и падеж** (K-8-7): кол-во языков — **33**
...
- **Прошедшее** (K-9-4): кол-во языков — **46**
- **Настоящее-будущее** (K-9-5): кол-во языков — **0**
- **Настоящее и прошедшее** (K-9-6): кол-во языков — **68**
...
- **Отсутствует** (K-12-1): кол-во языков — **56**
...
- **Всегда присутствует** (K-13-1): кол-во языков — **86**
...
- **По роду** (K-14-4): кол-во языков — **116**
...
- **Отсутствует** (K-16-1): кол-во языков — **108**
...
- **Числа и падежа** (K-16-6): кол-во языков — **39**
...
- **Преимущественно или только суффиксальная** (K-18-4): кол-во языков — **177**
...
- **Префиксы и суффиксы** (L-2-3): кол-во языков — **134**
...
- **Аккузативная** (M-1-3): кол-во языков — **181**
...
- **Финитные формы** (N-3-1): кол-во языков — **27**
