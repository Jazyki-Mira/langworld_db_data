...
- **Передний, средний и задний** (A-3-4): кол-во языков — **167**
...
- **Фонологические ступени долготы отсутствуют** (A-4-1): кол-во языков — **110**
...
- **В переднем, среднем и заднем рядах** (A-6-4): кол-во языков — **22**
...
- **Противопоставление гласных по фарингализации отсутствует** (A-7-1): кол-во языков — **134**
...
- **Билабиальные и лабиодентальные** (A-14-2): кол-во языков — **205**

## A-15 — Шумные переднеязычные согласные по месту образования

- **Дентальные** (A-15-1): кол-во языков — **29**
...
- **Велярные и лабиовелярные** (A-16-4): кол-во языков — **32**
...
- **Назальные, плавные и глайды** (A-19-3): кол-во языков — **6**
...
- **Лабиальные, переднеязычные, среднеязычные и заднеязычные** (A-20-17): кол-во языков — **68**
...
- **Ударение отсутствует** (B-1-1): кол-во языков — **19**
...
- **Нефонологическая** (B-9-2): кол-во языков — **60**
...
- **Назализация** (B-13-1): кол-во языков — **20**
...
- **Есть прикрытые и неприкрытые слоги** (C-1-5): кол-во языков — **217**

## C-2 — Конечный согласный в слоге

- **Обязательно имеется** (C-2-1): кол-во языков — **1**
- **Запрещен** (C-2-2): кол-во языков — **7**
...
- **Только гласные** (D-2-2): кол-во языков — **10**
...
- **Отсутствуют** (D-4-1): кол-во языков — **47**
...
- **Отсутствуют** (D-6-1): кол-во языков — **51**
...
- **Агглютинативный с элементами флективного** (E-1-2): кол-во языков — **60**
...
- **Согласовательные классы отсутствуют** (F-1-1): кол-во языков — **170**
...
- **Лексическое** (F-8-1): кол-во языков — **26**
...
- **Лексический** (F-9-1): кол-во языков — **32**
...
- **Единственное и множественное** (G-1-1): кол-во языков — **295**
...
- **Отсутствует** (G-4-1): кол-во языков — **20**
...
- **Единственное число** (G-5-1): кол-во языков — **40**
...
- **Неопределенный артикль отсутствует** (G-7-1): кол-во языков — **181**
...
- **Именные аффиксы и послелоги** (H-6-11): кол-во языков — **9**
...
- **Немаркированное** (H-7-2): кол-во языков — **22**
...
- **Отсутствуют** (H-9-2): кол-во языков — **99**
