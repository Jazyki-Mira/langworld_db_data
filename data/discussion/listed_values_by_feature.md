...
- **Есть абруптивные и преруптивные согласные** (A-11-20): кол-во языков — **1**
...
- **Дентальные, альвеолярные и передненебные** (A-15-31): кол-во языков — **5**
- **Дентальные, интердентальные, альвеолярные и передненебные** (A-15-32): кол-во языков — **4**
...
- **Гармоническое уподобление гласных отсутствует** (B-10-9): кол-во языков — **24**
...
- **Отсутствие полисемантизма флексий** (E-3-1): кол-во языков — **21**
...
- **Именные флексии и артикли** (F-2-6): кол-во языков — **2**
- **Именные флексии** (F-2-7): кол-во языков — **2**
...
- **Посессивные местоимения, прилагательные и аффиксы** (H-5-17): кол-во языков — **2**
...
- **Посессивные местоимения и прилагательные** (H-5-21): кол-во языков — **4**
...
- **Посессивные местоимения и прилагательные, личные местоимения и предлоги** (H-5-24): кол-во языков — **3**
- **Посессивные местоимения и прилагательные, личные местоимения, предлоги и посессивный артикль** (H-5-25): кол-во языков — **1**
...
- **Посессивные местоимения и прилагательные и предлоги** (H-5-29): кол-во языков — **2**
- **Возвратное местоимение и формы генитива личных местоимений** (H-5-30): кол-во языков — **2**
- **Посессивные местоимения и прилагательные и предложно-падежные конструкции** (H-5-31): кол-во языков — **1**
...
- **Указательные местоимения, наречия, предлоги и артикли** (J-2-25): кол-во языков — **9**
- **Указательные местоимения, наречия, предлоги и определенный артикль** (J-2-26): кол-во языков — **3**
...
- **Указательные местоимения, наречия, аффиксы, предлоги и артикли** (J-2-31): кол-во языков — **1**
- **Указательные и личные местоимения, наречия, предлоги и артикли** (J-2-32): кол-во языков — **1**
...
- **Указательные и непредметные местоимения и наречия** (J-2-35): кол-во языков — **1**
- **Указательные местоимения, непредметное местоимение, наречия, предлоги и артикли** (J-2-36): кол-во языков — **1**
- **Указательные и личные местоимения, непредметные местоимения, наречия, предлоги и артикли** (J-2-37): кол-во языков — **1**
...
- **Отрицательные частицы, местоимения и наречия** (J-8-15): кол-во языков — **24**
- **Отрицательные частицы, префиксы, союзы и местоимения** (J-8-16): кол-во языков — **0**
- **Отрицательные аффиксы, частицы и местоимения** (J-8-17): кол-во языков — **1**
- **Отрицательные частицы и местоимения** (J-8-18): кол-во языков — **1**
...
- **По классу, числу и падежу** (K-14-24): кол-во языков — **1**
- **По (не)определенности, роду, числу и падежу** (K-14-25): кол-во языков — **2**
- **По (не)определенности и падежу** (K-14-26): кол-во языков — **1**
...
- **Определение следует за определяемым** (M-4-2): кол-во языков — **37**
