...
- **Три** (A-1-2): кол-во языков — **202**
- **Четыре** (A-1-3): кол-во языков — **37**
...
- **Верхний, средний и нижний** (A-2-3): кол-во языков — **197**
...
- **Верхний, средне-верхний, средне-нижний и нижний** (A-2-6): кол-во языков — **3**
...
- **В среднем** (A-210-2): кол-во языков — **18**
...
- **Передний, средний и задний** (A-3-4): кол-во языков — **168**
...
- **Фонологические ступени долготы отсутствуют** (A-4-1): кол-во языков — **111**
...
- **Противопоставление гласных по лабиализации отсутствует** (A-5-1): кол-во языков — **129**
...
- **В переднем, среднем и заднем рядах** (A-6-4): кол-во языков — **23**
...
- **Противопоставление гласных по фарингализации отсутствует** (A-7-1): кол-во языков — **135**
...
- **Противопоставление гласных по продвинутости корня языка отсутствует** (A-8-1): кол-во языков — **126**
...
- **Противопоставление по звонкости/глухости** (A-11-1): кол-во языков — **212**
...
- **Только билабиальные** (A-14-1): кол-во языков — **80**
- **Билабиальные и лабиодентальные** (A-14-2): кол-во языков — **206**

## A-15 — Шумные переднеязычные согласные по месту образования

- **Дентальные** (A-15-1): кол-во языков — **30**
...
- **Только ларингальные** (A-17-4): кол-во языков — **16**
...
- **Назальные, плавные, вибранты и глайды** (A-19-6): кол-во языков — **154**
...
- **Лабиальные, переднеязычные и среднеязычные** (A-20-14): кол-во языков — **124**
...
- **Лабиальные, переднеязычные, среднеязычные и заднеязычные** (A-20-17): кол-во языков — **69**
...
- **Отсутствуют** (A-21-1): кол-во языков — **148**
...
- **Ударение отсутствует** (B-1-1): кол-во языков — **20**
...
- **Ровный, восходящий и нисходящий** (B-7-7): кол-во языков — **7**
...
- **Нефонологическая** (B-9-2): кол-во языков — **61**
...
- **Подъем** (B-11-3): кол-во языков — **11**
...
- **Назализация** (B-13-1): кол-во языков — **21**
...
- **Есть прикрытые и неприкрытые слоги** (C-1-5): кол-во языков — **218**
...
- **Большинство слогов открытые** (C-2-4): кол-во языков — **30**
...
- **Ограниченный набор согласных** (D-1-4): кол-во языков — **37**
- **Запрет на любые стечения гласных** (D-1-5): кол-во языков — **3**
- **Запрет на любые стечения согласных** (D-1-6): кол-во языков — **44**
...
- **Ограничения на последовательность согласных** (D-1-13): кол-во языков — **5**
...
- **Отсутствуют** (D-4-1): кол-во языков — **48**
...
- **Различия в структуре слога** (D-5-4): кол-во языков — **19**
...
- **Сопутствующие** (D-7-2): кол-во языков — **43**
- **Смыслоразличительные** (D-7-3): кол-во языков — **16**
- **Сопутствующие и смыслоразличительные** (D-7-4): кол-во языков — **79**
...
- **Вокалические и консонантные** (D-8-6): кол-во языков — **64**
...
- **Агглютинативный с элементами флективного** (E-1-2): кол-во языков — **61**
- **Флективный** (E-1-3): кол-во языков — **88**
...
- **Фонетически необусловленная фузия** (E-2-4): кол-во языков — **7**
...
- **Согласовательные классы отсутствуют** (F-1-1): кол-во языков — **171**
...
- **Отсутствует** (F-5-4): кол-во языков — **13**
...
- **Лексический** (F-9-1): кол-во языков — **33**
- **Морфологический** (F-9-2): кол-во языков — **5**
- **Синтаксический** (F-9-3): кол-во языков — **4**
...
- **Единственное и множественное** (G-1-1): кол-во языков — **296**
...
- **Отсутствует** (G-4-1): кол-во языков — **21**
- **Предикативное** (G-4-2): кол-во языков — **105**
- **Атрибутивное** (G-4-3): кол-во языков — **10**
- **Предикативное и атрибутивное** (G-4-4): кол-во языков — **149**

## G-5 — Форма имен после числительного

- **Единственное число** (G-5-1): кол-во языков — **41**
- **Множественное число** (G-5-2): кол-во языков — **12**
- **Единственное и множественное число** (G-5-3): кол-во языков — **128**
...
- **Неопределенный артикль отсутствует** (G-7-1): кол-во языков — **182**
- **Совпадают** (G-7-2): кол-во языков — **55**
- **Не совпадают** (G-7-3): кол-во языков — **7**

## H-1 — Количество падежей у имени существительного

- **Один-два** (H-1-1): кол-во языков — **54**
- **Три-семь** (H-1-2): кол-во языков — **121**
...
- **Послелоги** (H-6-5): кол-во языков — **10**
...
- **Именные аффиксы и послелоги** (H-6-11): кол-во языков — **10**
...
- **Маркированное** (H-7-1): кол-во языков — **71**
- **Немаркированное** (H-7-2): кол-во языков — **23**

## H-8 — Падежное оформление одушевленных и неодушевленных имен

- **Одинаковое** (H-8-1): кол-во языков — **69**
...
- **Категория залога отсутствует** (I-1-1): кол-во языков — **46**
...
- **Настоящее, прошедшее и будущее** (I-5-7): кол-во языков — **133**
...
- **Синкретическое** (I-6-2): кол-во языков — **167**
...
- **Вид и время** (I-8-2): кол-во языков — **16**
...
- **Отсутствует** (I-10-1): кол-во языков — **76**
...
- **Послелоги** (J-3-2): кол-во языков — **55**
...
- **Отсутствует** (J-5-1): кол-во языков — **117**
- **Именные аффиксы** (J-5-2): кол-во языков — **23**
...
- **Артикли** (J-6-1): кол-во языков — **55**
...
- **В именной группе и местоимениях** (J-7-5): кол-во языков — **0**
- **В глагольной группе и местоимениях** (J-7-6): кол-во языков — **31**
...
- **В именной и глагольной группах и местоимениях** (J-7-10): кол-во языков — **1**
...
- **Отрицательные частицы** (J-8-3): кол-во языков — **76**
...
- **Препозиция** (J-9-3): кол-во языков — **127**
...
- **Собственный тип склонения** (K-1-3): кол-во языков — **159**

## K-2 — Типы артиклей

- **Артикли отсутствуют** (K-2-1): кол-во языков — **188**
- **Только неопределенные** (K-2-2): кол-во языков — **21**
- **Только определенные** (K-2-3): кол-во языков — **27**
- **Определенные и неопределенные** (K-2-4): кол-во языков — **60**
- **Определенные, неопределенные и партитивные** (K-2-5): кол-во языков — **0**

## K-3 — Расположение артикля

- **Препозиция** (K-3-1): кол-во языков — **51**
- **Постпозиция** (K-3-2): кол-во языков — **25**
- **Препозиция и постпозиция** (K-3-3): кол-во языков — **26**

## K-4 — Постановка артикля в именной группе

- **Единый артикль для всей именной группы** (K-4-1): кол-во языков — **60**
...
- **Определенность** (K-5-2): кол-во языков — **38**
...
- **Единый тип спряжения** (K-6-1): кол-во языков — **108**
...
- **Субъектное** (K-7-2): кол-во языков — **188**
...
- **Отсутствуют** (K-8-1): кол-во языков — **64**
...
- **Число и падеж** (K-8-8): кол-во языков — **3**
...
- **Отсутствуют** (K-11-1): кол-во языков — **96**
...
- **Отсутствует** (K-12-1): кол-во языков — **50**
...
- **Отсутствует** (K-13-2): кол-во языков — **88**
- **Только в препозиции** (K-13-3): кол-во языков — **9**
- **Факультативно** (K-13-4): кол-во языков — **13**
...
- **По роду** (K-14-4): кол-во языков — **100**
- **По числу** (K-14-5): кол-во языков — **131**
- **По падежу** (K-14-6): кол-во языков — **60**
...
- **Число и падеж** (K-15-7): кол-во языков — **121**
...
- **Отсутствует** (K-16-1): кол-во языков — **96**
...
- **Внутренняя флексия и аффиксы** (K-17-5): кол-во языков — **46**
...
- **Префиксально-суффиксальная** (K-18-1): кол-во языков — **131**
...
- **Преимущественно или только суффиксальная** (K-18-4): кол-во языков — **164**
...
- **Аффиксация и редупликация** (L-1-9): кол-во языков — **7**
...
- **Суффиксы** (L-2-2): кол-во языков — **112**
- **Префиксы и суффиксы** (L-2-3): кол-во языков — **114**
...
- **Аккузативная** (M-1-3): кол-во языков — **171**
...
- **Номинативная и эргативная** (M-1-10): кол-во языков — **2**

## M-2 — Фиксированность порядка слов

- **Жесткий** (M-2-1): кол-во языков — **92**
- **Свободный** (M-2-2): кол-во языков — **64**
- **Относительно свободный** (M-2-3): кол-во языков — **24**

## M-3 — Основной порядок слов в предложении

- **SVO** (M-3-1): кол-во языков — **71**
- **SOV** (M-3-2): кол-во языков — **193**
...
- **Определение предшествует определяемому** (M-4-1): кол-во языков — **157**
- **Определение следует за определяемым** (M-4-2): кол-во языков — **40**
- **Не фиксирован** (M-4-3): кол-во языков — **31**
- **Препозиция или постпозиция** (M-4-4): кол-во языков — **0**

## M-5 — Опущение местоименного подлежащего в неэллиптических предложениях

- **Возможно** (M-5-1): кол-во языков — **49**
- **Невозможно** (M-5-2): кол-во языков — **28**
...
- **Не фиксирован** (N-1-3): кол-во языков — **81**
...
- **Особое оформление сказуемого** (N-2-4): кол-во языков — **16**

## N-3 — Оформление сказуемого в придаточном предложении

- **Финитные формы** (N-3-1): кол-во языков — **26**
- **Нефинитные формы** (N-3-2): кол-во языков — **7**
- **Финитные и нефинитные формы** (N-3-3): кол-во языков — **72**
...
- **Сочинение, подчинение и цепочки клауз** (N-4-5): кол-во языков — **18**
...
- **Союзная и бессоюзная** (N-5-3): кол-во языков — **187**