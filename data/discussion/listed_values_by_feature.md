...
- **Противопоставление гласных по назализации отсутствует** (A-6-1): кол-во языков — **220**
...
- **Противопоставление гласных по фарингализации отсутствует** (A-7-1): кол-во языков — **161**
...
- **Противопоставление гласных по продвинутости корня языка отсутствует** (A-8-1): кол-во языков — **154**
...
- **Флективный с элементами агглютинации** (E-1-4): кол-во языков — **54**
...
- **Отсутствие полисемантизма флексий, единый тип склонения или спряжения, постоянство морфемного облика и совпадение исходной формы с чистой основой** (E-3-6): кол-во языков — **3**
...
- **Синтетический с элементами аналитизма** (E-4-6): кол-во языков — **204**
...
- **Немаркированное** (G-2-2): кол-во языков — **235**
...
- **Предикативное** (G-4-2): кол-во языков — **109**
...
- **Категория падежа отсутствует** (H-1-6): кол-во языков — **25**
...
- **Лицо, число, время, вид и модальность (наклонение)** (I-8-17): кол-во языков — **76**
...
- **Особый тип согласования** (I-10-5): кол-во языков — **38**
...
- **Местоимения-существительные и местоимения-прилагательные** (J-1-11): кол-во языков — **75**
...
- **Предлоги** (J-3-3): кол-во языков — **74**
...
- **Местоимения** (J-4-4): кол-во языков — **43**
...
- **Местоимения не склоняются** (K-1-1): кол-во языков — **18**
...
- **Не совпадают** (K-3-2): кол-во языков — **14**

## K-4 — Расположение артикля

- **Препозиция** (K-4-1): кол-во языков — **50**
- **Постпозиция** (K-4-2): кол-во языков — **32**
- **Препозиция и постпозиция** (K-4-3): кол-во языков — **29**

## K-5 — Постановка артикля в именной группе

- **Единый артикль для всей именной группы** (K-5-1): кол-во языков — **69**
...
- **Единый тип спряжения** (K-7-1): кол-во языков — **129**
- **Два типа спряжения** (K-7-2): кол-во языков — **63**
...
- **Субъектное** (K-8-2): кол-во языков — **213**
...
- **Отсутствуют** (K-9-1): кол-во языков — **68**
...
- **Прошедшее** (K-10-4): кол-во языков — **48**
...
- **Степени сравнения** (K-11-2): кол-во языков — **42**

## K-12 — Согласовательные категории, выражаемые прилагательным

- **Отсутствуют** (K-12-1): кол-во языков — **103**
...
- **Отсутствует** (K-13-1): кол-во языков — **60**
...
- **Отсутствует** (K-14-2): кол-во языков — **91**
...
- **По числу** (K-15-2): кол-во языков — **154**
...
- **Отсутствует** (K-17-1): кол-во языков — **110**
...
- **Аффиксы** (K-18-2): кол-во языков — **165**
